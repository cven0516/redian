...
给请不起营销团队的小店用的热点借势营销 AI 助手。只要告诉它你的店在哪、卖什么、有什么困境，10分钟内帮你：

- 🔥 扫描当前热点（抖音热榜、小红书趋势、本地活动、营销日历）
- 🎯 匹配最适合你的借势方向
- 💡 出 2-3 个策划概念让你选
- 📄 输出完整 SMART 策划案（内容矩阵+活动机制+投放策略+预算）
- 🎨 规划社交媒体视觉内容和线下物料，附可直接复制的 AI 生图提示词
...
```
用户输入 → 门店快诊 → 热点雷达 → 方向匹配(用户选) → 策划匹配(用户选) → SMART策划案 → PitchDeck摘要 → [视觉规划] → [Dashboard]
```
